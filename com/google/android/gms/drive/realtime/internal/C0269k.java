...
public interface C0269k extends IInterface {

    /* renamed from: com.google.android.gms.drive.realtime.internal.k.a */
    public static abstract class C0670a extends Binder implements C0269k {

        /* renamed from: com.google.android.gms.drive.realtime.internal.k.a.a */
        private static class C0669a implements C0269k {
            private IBinder kq;
            ...
            public void m2109a(ParcelableIndexReference parcelableIndexReference) throws RemoteException {
            ...
            public void m2110o(Status status) throws RemoteException {
                Parcel obtain = Parcel.obtain();
                Parcel obtain2 = Parcel.obtain();
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.drive.realtime.internal.IIndexReferenceCallback");
        ...
        public static C0269k aa(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof C0269k)) ? new C0669a(iBinder) : (C0269k) queryLocalInterface;
        }
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                case DataEvent.TYPE_CHANGED /*1*/:
                    ...
                    m410a(parcelableIndexReference);
    ...
    void m410a(ParcelableIndexReference parcelableIndexReference) throws RemoteException;

    void m411o(Status status) throws RemoteException;
}
