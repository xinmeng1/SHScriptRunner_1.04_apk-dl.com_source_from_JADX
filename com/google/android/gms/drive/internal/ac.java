...
public interface ac extends IInterface {
    ...
    public static abstract class C0647a extends Binder implements ac {

        /* renamed from: com.google.android.gms.drive.internal.ac.a.a */
        private static class C0646a implements ac {
            private IBinder kq;
            ...
            public void m2074a(OnEventResponse onEventResponse) throws RemoteException {
        ...
        public static ac m2075R(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof ac)) ? new C0646a(iBinder) : (ac) queryLocalInterface;
        }
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            switch (code) {
                case DataEvent.TYPE_CHANGED /*1*/:
                    ...
                    m317a(data.readInt() != 0 ? (OnEventResponse) OnEventResponse.CREATOR.createFromParcel(data) : null);
    ...
    void m317a(OnEventResponse onEventResponse) throws RemoteException;
}
