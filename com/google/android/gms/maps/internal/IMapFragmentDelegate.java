...
import com.google.android.gms.maps.internal.IGoogleMapDelegate.C0849a;
import com.google.android.gms.wearable.DataEvent;

public interface IMapFragmentDelegate extends IInterface {

    /* renamed from: com.google.android.gms.maps.internal.IMapFragmentDelegate.a */
    public static abstract class C0853a extends Binder implements IMapFragmentDelegate {

        /* renamed from: com.google.android.gms.maps.internal.IMapFragmentDelegate.a.a */
        private static class C0852a implements IMapFragmentDelegate {
            private IBinder kq;
            ...
            public IGoogleMapDelegate getMap() throws RemoteException {
                ...
                try {
                    ...
                    IGoogleMapDelegate ay = C0849a.ay(obtain2.readStrongBinder());
                    return ay;
                } finally {
                    obtain2.recycle();
                    obtain.recycle();
            ...
            public void onInflate(C0280d activityWrapper, GoogleMapOptions options, Bundle savedInstanceState) throws RemoteException {
                Parcel obtain = Parcel.obtain();
                Parcel obtain2 = Parcel.obtain();
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.maps.internal.IMapFragmentDelegate");
        ...
        public static IMapFragmentDelegate aB(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof IMapFragmentDelegate)) ? new C0852a(iBinder) : (IMapFragmentDelegate) queryLocalInterface;
        }
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case DataEvent.TYPE_DELETED /*2*/:
                    data.enforceInterface("com.google.android.gms.maps.internal.IMapFragmentDelegate");
                    onInflate(C0688a.ag(data.readStrongBinder()), data.readInt() != 0 ? GoogleMapOptions.CREATOR.createFromParcel(data) : null, data.readInt() != 0 ? (Bundle) Bundle.CREATOR.createFromParcel(data) : null);
                    reply.writeNoException();
                    return true;
    ...
    void onInflate(C0280d c0280d, GoogleMapOptions googleMapOptions, Bundle bundle) throws RemoteException;
