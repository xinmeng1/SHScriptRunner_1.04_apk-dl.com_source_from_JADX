...
public interface C0413b extends IInterface {
    ...
    public static abstract class C0867a extends Binder implements C0413b {

        /* renamed from: com.google.android.gms.maps.internal.b.a.a */
        private static class C0866a implements C0413b {
            private IBinder kq;
        ...
        public static C0413b aw(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            IInterface queryLocalInterface = iBinder.queryLocalInterface("com.google.android.gms.maps.internal.ICancelableCallback");
            return (queryLocalInterface == null || !(queryLocalInterface instanceof C0413b)) ? new C0866a(iBinder) : (C0413b) queryLocalInterface;
        }
