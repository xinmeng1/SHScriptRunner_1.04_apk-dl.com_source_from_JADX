...
public interface IPolylineDelegate extends IInterface {
    ...
    public static abstract class C0904a extends Binder implements IPolylineDelegate {

        /* renamed from: com.google.android.gms.maps.model.internal.IPolylineDelegate.a.a */
        private static class C0903a implements IPolylineDelegate {
            private IBinder kq;
        ...
        public static IPolylineDelegate be(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof IPolylineDelegate)) ? new C0903a(iBinder) : (IPolylineDelegate) queryLocalInterface;
        }
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case GamesStatusCodes.STATUS_TIMEOUT /*15*/:
                    data.enforceInterface("com.google.android.gms.maps.model.internal.IPolylineDelegate");
                    isVisible = equalsRemote(C0904a.be(data.readStrongBinder()));
                    reply.writeNoException();
                    if (isVisible) {
                        i = 1;
                    }
