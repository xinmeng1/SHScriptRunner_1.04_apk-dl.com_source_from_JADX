...
public final class ao {
    ...
    public ao(Context context, AttributeSet attributeSet) {
        int i = 1;
        TypedArray obtainAttributes = context.getResources().obtainAttributes(attributeSet, C0128R.styleable.AdsAttrs);
        ...
        if (i2 != 0 && r1 == 0) {
            this.mi = m787f(string);
        } else if (i2 == 0 && r1 != 0) {
            this.mi = m787f(string2);
        } else if (i2 == 0 || r1 == 0) {
    ...
    private static AdSize[] m787f(String str) {
