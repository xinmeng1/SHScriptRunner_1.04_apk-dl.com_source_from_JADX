...
public interface lk extends IInterface {
    ...
    public static abstract class C0809a extends Binder implements lk {

        /* renamed from: com.google.android.gms.internal.lk.a.a */
        private static class C0808a implements lk {
            private IBinder kq;

            C0808a(IBinder iBinder) {
                this.kq = iBinder;
            }

            public void m2791a(C0280d c0280d, WalletFragmentOptions walletFragmentOptions, Bundle bundle) throws RemoteException {
        ...
        public static lk bo(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof lk)) ? new C0808a(iBinder) : (lk) queryLocalInterface;
        }
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                case DataEvent.TYPE_CHANGED /*1*/:
                    ...
                    m1342a(C0688a.ag(data.readStrongBinder()), data.readInt() != 0 ? (WalletFragmentOptions) WalletFragmentOptions.CREATOR.createFromParcel(data) : null, data.readInt() != 0 ? (Bundle) Bundle.CREATOR.createFromParcel(data) : null);
    ...
    void m1342a(C0280d c0280d, WalletFragmentOptions walletFragmentOptions, Bundle bundle) throws RemoteException;
