...
public interface co extends IInterface {
    ...
    public static abstract class C0724a extends Binder implements co {

        /* renamed from: com.google.android.gms.internal.co.a.a */
        private static class C0723a implements co {
            private IBinder kq;
            ...
            public IBinder m2517a(C0280d c0280d) throws RemoteException {
        ...
        public static co m2518n(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            IInterface queryLocalInterface = iBinder.queryLocalInterface("com.google.android.gms.ads.internal.overlay.client.IAdOverlayCreator");
            return (queryLocalInterface == null || !(queryLocalInterface instanceof co)) ? new C0723a(iBinder) : (co) queryLocalInterface;
        }
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            switch (code) {
                case DataEvent.TYPE_CHANGED /*1*/:
                    ...
                    IBinder a = m866a(C0688a.ag(data.readStrongBinder()));
    ...
    IBinder m866a(C0280d c0280d) throws RemoteException;
}
