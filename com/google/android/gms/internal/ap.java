...
public interface ap extends IInterface {
    ...
    public static abstract class C0699a extends Binder implements ap {

        /* renamed from: com.google.android.gms.internal.ap.a.a */
        private static class C0698a implements ap {
            private IBinder kq;
        ...
        public static ap m2457e(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            IInterface queryLocalInterface = iBinder.queryLocalInterface("com.google.android.gms.ads.internal.client.IAdListener");
            return (queryLocalInterface == null || !(queryLocalInterface instanceof ap)) ? new C0698a(iBinder) : (ap) queryLocalInterface;
        }
