...
public final class gu {
    public static Bitmap m1153a(Bitmap bitmap) {
        int i = 0;
        if (bitmap == null) {
            return null;
        }
    ...
    private static Bitmap m1154a(Drawable drawable) {
        if (drawable == null) {
            return null;
        }
    ...
    public static Drawable m1155a(Resources resources, Drawable drawable) {
        return new BitmapDrawable(resources, m1153a(m1154a(drawable)));
    }
}
