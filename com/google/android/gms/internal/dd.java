...
public interface dd extends IInterface {
    ...
    public static abstract class C0730a extends Binder implements dd {

        /* renamed from: com.google.android.gms.internal.dd.a.a */
        private static class C0729a implements dd {
            private IBinder kq;
        ...
        public static dd m2530r(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof dd)) ? new C0729a(iBinder) : (dd) queryLocalInterface;
        }
