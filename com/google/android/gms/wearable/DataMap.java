...
public class DataMap {
    ...
    private final HashMap<String, Object> alk;

    public DataMap() {
        this.alk = new HashMap();
    }

    private static void m1796a(Bundle bundle, String str, Object obj) {
    ...
    private static void m1797a(DataMap dataMap, String str, Object obj) {
        if (obj instanceof String) {
    ...
    private void m1798a(String str, Object obj, String str2, ClassCastException classCastException) {
        m1799a(str, obj, str2, "<null>", classCastException);
    }

    private void m1799a(String str, Object obj, String str2, Object obj2, ClassCastException classCastException) {
    ...
    private static boolean m1800a(Asset asset, Asset asset2) {
    ...
    private static boolean m1801a(DataMap dataMap, DataMap dataMap2) {
        ...
        for (String str : dataMap.keySet()) {
            ...
            if (obj instanceof Asset) {
                ...
                if (!m1800a((Asset) obj, (Asset) obj2)) {
                    return false;
                }
            } else if (obj instanceof String[]) {
    ...
    private static int m1802c(ArrayList<?> arrayList) {
    ...
    public static DataMap fromBundle(Bundle bundle) {
        ...
        for (String str : bundle.keySet()) {
            m1797a(dataMap, str, bundle.get(str));
        }
        return dataMap;
    }
    ...
    public static DataMap fromByteArray(byte[] bytes) {
        try {
            return lv.m1364a(new C0391a(lw.m3750n(bytes), new ArrayList()));
        } catch (Throwable e) {
    ...
    public boolean equals(Object o) {
        return !(o instanceof DataMap) ? false : m1801a(this, (DataMap) o);
    }
    ...
    public boolean getBoolean(String key, boolean defaultValue) {
        ...
        if (obj != null) {
            try {
                ...
                m1799a(key, obj, "Boolean", Boolean.valueOf(defaultValue), e);
            }
        }
        return defaultValue;
    }
    ...
    public byte getByte(String key, byte defaultValue) {
        ...
        if (obj != null) {
            try {
                ...
                m1799a(key, obj, "Byte", Byte.valueOf(defaultValue), e);
            }
        }
        return defaultValue;
    }
    ...
    public ArrayList<DataMap> getDataMapArrayList(String key) {
        ...
        try {
            ...
            m1798a(key, obj, "ArrayList<DataMap>", e);
            return null;
        }
    }
    ...
    public double getDouble(String key, double defaultValue) {
        ...
        if (obj != null) {
            try {
                ...
                m1799a(key, obj, "Double", Double.valueOf(defaultValue), e);
            }
        }
        return defaultValue;
    }
    ...
    public float getFloat(String key, float defaultValue) {
        ...
        if (obj != null) {
            try {
                ...
                m1799a(key, obj, "Float", Float.valueOf(defaultValue), e);
            }
        }
        return defaultValue;
    }
    ...
    public ArrayList<Integer> getIntegerArrayList(String key) {
        ...
        try {
            ...
            m1798a(key, obj, "ArrayList<Integer>", e);
            return null;
        }
    }
    ...
    public ArrayList<String> getStringArrayList(String key) {
        ...
        try {
            ...
            m1798a(key, obj, "ArrayList<String>", e);
            return null;
        }
    }
    ...
    public Bundle toBundle() {
        ...
        for (String str : this.alk.keySet()) {
            m1796a(bundle, str, this.alk.get(str));
        }
        return bundle;
    }

    public byte[] toByteArray() {
        return me.m1428d(lv.m1362a(this).amp);
    }
