...
public class Dimension {
    ...
    public static int m1755a(long j, DisplayMetrics displayMetrics) {
        int i = (int) (j >>> 32);
        int i2 = (int) j;
        switch (i) {
            case UNIT_PX /*0*/:
    ...
    public static long m1756a(int i, float f) {
        switch (i) {
            case UNIT_PX /*0*/:
            case UNIT_DIP /*1*/:
            case UNIT_SP /*2*/:
            ...
            case UNIT_IN /*4*/:
            case UNIT_MM /*5*/:
                return m1758l(i, Float.floatToIntBits(f));
            default:
                throw new IllegalArgumentException("Unrecognized unit: " + i);
        }
    }

    public static long m1757a(TypedValue typedValue) {
        switch (typedValue.type) {
            case UNIT_MM /*5*/:
                return m1758l(TransportMediator.FLAG_KEY_MEDIA_NEXT, typedValue.data);
    ...
    public static long dM(int i) {
        if (i >= 0) {
            return m1756a((int) UNIT_PX, (float) i);
        }
    ...
    private static long m1758l(int i, int i2) {
