...
import com.google.android.gms.tagmanager.da.C0503a;
...
class ca implements at {
    ...
    class C0483b extends SQLiteOpenHelper {
        final /* synthetic */ ca agt;
        private boolean wX;
        private long wY;

        C0483b(ca caVar, Context context, String str) {
            this.agt = caVar;
    ...
    class C0954a implements C0503a {
        final /* synthetic */ ca agt;
        ...
        public void m2974a(ap apVar) {
            this.agt.m2985y(apVar.dl());
        }

        public void m2975b(ap apVar) {
            this.agt.m2985y(apVar.dl());
            bh.m1644C("Permanent failure dispatching hitId: " + apVar.dl());
        }

        public void m2976c(ap apVar) {
            long lN = apVar.lN();
            if (lN == 0) {
    ...
    static {
        wP = String.format("CREATE TABLE IF NOT EXISTS %s ( '%s' INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, '%s' INTEGER NOT NULL, '%s' TEXT NOT NULL,'%s' INTEGER NOT NULL);", new Object[]{"gtm_hits", "hit_id", "hit_time", "hit_url", "hit_first_send_time"});
    }
    ...
    ca(au auVar, Context context, String str, int i) {
        ...
        this.ags = auVar;
        this.aef = il.gb();
        this.agq = new C0483b(this, this.mContext, this.wS);
        this.agr = new da(new DefaultHttpClient(), this.mContext, new C0954a(this));
        this.wU = 0;
        this.wV = i;
    }
    ...
    public java.util.List<com.google.android.gms.tagmanager.ap> m2987B(int r17) {
        /*
        r16 = this;
    ...
    L_0x00ac:
        ...
        r2.m1629R(r5);	 Catch:{ SQLiteException -> 0x0114, all -> 0x0166 }
    L_0x00ba:
        r2 = r4 + 1;
    ...
    L_0x00ce:
        ...
        com.google.android.gms.tagmanager.bh.m1645D(r3);	 Catch:{ all -> 0x016e }
    ...
    L_0x00f6:
        ...
        r2 = r12.get(r4);	 Catch:{ SQLiteException -> 0x0114, all -> 0x0166 }
        r2 = (com.google.android.gms.tagmanager.ap) r2;	 Catch:{ SQLiteException -> 0x0114, all -> 0x0166 }
        r8 = r2.dl();	 Catch:{ SQLiteException -> 0x0114, all -> 0x0166 }
        ...
        com.google.android.gms.tagmanager.bh.m1645D(r2);	 Catch:{ SQLiteException -> 0x0114, all -> 0x0166 }
        goto L_0x00ba;
    L_0x0114:
        r2 = move-exception;
        r13 = r3;
    L_0x0116:
        ...
        com.google.android.gms.tagmanager.bh.m1645D(r2);	 Catch:{ all -> 0x015f }
    ...
    public void m2989f(long j, String str) {
        ds();
        dr();
        m2984g(j, str);
    }
