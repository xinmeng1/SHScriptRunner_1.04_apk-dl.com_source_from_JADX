...
public final class PlusShare {
    ...
    public static class Builder {
        ...
        public Builder(Activity launchingActivity, PlusClient plusClient) {
            ...
            hm.m1226a(plusClient != null, "PlusClient must not be null.");
            hm.m1226a(plusClient.isConnected(), "PlusClient must be connected to create an interactive post.");
            hm.m1226a(plusClient.jS().by(Scopes.PLUS_LOGIN), "Must request PLUS_LOGIN scope in PlusClient to create an interactive post.");
        ...
        public Builder addCallToAction(String label, Uri uri, String deepLinkId) {
            hm.m1226a(this.abH, "Must include the launching activity with PlusShare.Builder constructor before setting call-to-action");
            boolean z = (uri == null || TextUtils.isEmpty(uri.toString())) ? false : true;
            hm.m1230b(z, (Object) "Must provide a call to action URL");
            ...
            if (!TextUtils.isEmpty(deepLinkId)) {
                hm.m1226a(PlusShare.bv(deepLinkId), "The specified deep-link ID was malformed.");
        ...
        public Intent getIntent() {
            ...
            hm.m1226a(z3, "Call-to-action buttons are only available for URLs.");
            z3 = !booleanExtra || this.mIntent.hasExtra(PlusShare.EXTRA_CONTENT_URL);
            hm.m1226a(z3, "The content URL is required for interactive posts.");
            ...
            hm.m1226a(z, "Must set content URL or content deep-link ID to use a call-to-action button.");
            if (this.mIntent.hasExtra(PlusShare.EXTRA_CONTENT_DEEP_LINK_ID)) {
                hm.m1226a(PlusShare.bv(this.mIntent.getStringExtra(PlusShare.EXTRA_CONTENT_DEEP_LINK_ID)), "The specified deep-link ID was malformed.");
            }
            if (!z2 && equals) {
        ...
        public Builder setContentDeepLinkId(String deepLinkId, String title, String description, Uri thumbnailUri) {
            hm.m1230b(this.abH, (Object) "Must include the launching activity with PlusShare.Builder constructor before setting deep links");
            hm.m1230b(!TextUtils.isEmpty(deepLinkId), (Object) "The deepLinkId parameter is required.");
            Bundle a = PlusShare.m1554a(title, description, thumbnailUri);
    ...
    public static Bundle m1554a(String str, String str2, Uri uri) {
        Bundle bundle = new Bundle();
