...
public class SearchView extends LinearLayout implements CollapsibleActionView {
    ...
    class C01094 implements OnFocusChangeListener {
        C01094() {
        }
    ...
    class C01105 implements OnLayoutChangeListener {
        C01105() {
        }
    ...
    class C01116 implements OnGlobalLayoutListener {
        C01116() {
        }
    ...
    class C01127 implements OnClickListener {
        C01127() {
        }
    ...
    class C01138 implements OnKeyListener {
        C01138() {
        }
    ...
    class C01149 implements OnEditorActionListener {
        C01149() {
        }
    ...
    public SearchView(Context context, AttributeSet attrs) {
        super(context, attrs);
        this.mShowImeRunnable = new C01061();
        this.mUpdateDrawableStateRunnable = new C01072();
        this.mReleaseCursorRunnable = new C01083();
        this.mOutsideDrawablesCache = new WeakHashMap();
        this.mOnClickListener = new C01127();
        this.mTextKeyListener = new C01138();
        this.mOnEditorActionListener = new C01149();
        ...
        ((LayoutInflater) context.getSystemService("layout_inflater")).inflate(C0085R.layout.abc_search_view, this, true);
        this.mSearchButton = findViewById(C0085R.id.search_button);
        this.mQueryTextView = (SearchAutoComplete) findViewById(C0085R.id.search_src_text);
        this.mQueryTextView.setSearchView(this);
        this.mSearchEditFrame = findViewById(C0085R.id.search_edit_frame);
        this.mSearchPlate = findViewById(C0085R.id.search_plate);
        this.mSubmitArea = findViewById(C0085R.id.submit_area);
        this.mSubmitButton = findViewById(C0085R.id.search_go_btn);
        this.mCloseButton = (ImageView) findViewById(C0085R.id.search_close_btn);
        this.mVoiceButton = findViewById(C0085R.id.search_voice_btn);
        this.mSearchHintIcon = (ImageView) findViewById(C0085R.id.search_mag_icon);
        ...
        this.mQueryTextView.setOnFocusChangeListener(new C01094());
        TypedArray a = context.obtainStyledAttributes(attrs, C0085R.styleable.SearchView, 0, 0);
        ...
        a.recycle();
        a = context.obtainStyledAttributes(attrs, C0085R.styleable.View, 0, 0);
    ...
    private void addOnLayoutChangeListenerToDropDownAnchorSDK11() {
        this.mDropDownAnchor.addOnLayoutChangeListener(new C01105());
    }

    private void addOnLayoutChangeListenerToDropDownAnchorBase() {
        this.mDropDownAnchor.getViewTreeObserver().addOnGlobalLayoutListener(new C01116());
    }
    ...
    private int getPreferredWidth() {
        return getContext().getResources().getDimensionPixelSize(C0085R.dimen.abc_search_view_preferred_width);
    }
    ...
    private int getSearchIconId() {
        ...
        getContext().getTheme().resolveAttribute(C0085R.attr.searchViewSearchIcon, outValue, true);
    ...
    private void updateSearchAutoComplete() {
        ...
        if ((inputType & 15) == 1) {
            ...
            if (this.mSearchable.getSuggestAuthority() != null) {
                inputType = (inputType | Cast.MAX_MESSAGE_LENGTH) | AccessibilityEventCompat.TYPE_GESTURE_DETECTION_END;
            }
        }
        this.mQueryTextView.setInputType(inputType);
    ...
    private void adjustDropDownSizeAndPosition() {
        if (this.mDropDownAnchor.getWidth() > 1) {
            ...
            int iconOffset = this.mIconifiedByDefault ? res.getDimensionPixelSize(C0085R.dimen.abc_dropdownitem_icon_width) + res.getDimensionPixelSize(C0085R.dimen.abc_dropdownitem_text_padding_left) : 0;
