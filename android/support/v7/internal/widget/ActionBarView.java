...
public class ActionBarView extends AbsActionBarView {
    ...
    private static class HomeView extends FrameLayout {
        ...
        protected void onFinishInflate() {
            this.mUpView = (ImageView) findViewById(C0085R.id.up);
            this.mIconView = (ImageView) findViewById(C0085R.id.home);
    ...
    static class SavedState extends BaseSavedState {
        ...
        static class C00941 implements Creator<SavedState> {
            C00941() {
            }
    ...
    class C05991 implements OnItemSelectedListener {
        C05991() {
        }
    ...
    public ActionBarView(Context context, AttributeSet attrs) {
        ...
        this.mNavItemSelectedListener = new C05991();
        this.mExpandedActionViewUpListener = new C00922();
        this.mUpClickListener = new C00933();
        this.mContext = context;
        setBackgroundResource(DISPLAY_DEFAULT);
        TypedArray a = context.obtainStyledAttributes(attrs, C0085R.styleable.ActionBar, C0085R.attr.actionBarStyle, DISPLAY_DEFAULT);
        ApplicationInfo appInfo = context.getApplicationInfo();
        PackageManager pm = context.getPackageManager();
        this.mNavigationMode = a.getInt(2, DISPLAY_DEFAULT);
        this.mTitle = a.getText(DISPLAY_DEFAULT);
        ...
        int homeResId = a.getResourceId(14, C0085R.layout.abc_action_bar_home);
        ...
        this.mExpandedHomeLayout.setContentDescription(getResources().getText(C0085R.string.abc_action_bar_up_description));
        ...
        this.mContentHeight = a.getLayoutDimension(1, DISPLAY_DEFAULT);
        a.recycle();
    ...
    public void initProgress() {
        ...
        this.mProgressView.setId(C0085R.id.progress_horizontal);
    ...
    public void initIndeterminateProgress() {
        ...
        this.mIndeterminateProgressView.setId(C0085R.id.progress_circular);
        ...
        if (this.mSplitActionBar != splitActionBar) {
            ...
            if (this.mActionMenuPresenter != null) {
                if (splitActionBar) {
                    ...
                    this.mActionMenuPresenter.setExpandedActionViewsExclusive(getResources().getBoolean(C0085R.bool.abc_action_bar_expanded_action_views_exclusive));
                }
            }
    ...
    public void setMenu(SupportMenu menu, MenuPresenter.Callback cb) {
        if (menu != this.mOptionsMenu) {
            ...
            if (this.mActionMenuPresenter == null) {
                ...
                this.mActionMenuPresenter.setId(C0085R.id.action_menu_presenter);
    ...
    public void setHomeButtonEnabled(boolean enable) {
        ...
        if (!enable) {
            ...
            this.mHomeLayout.setContentDescription(this.mContext.getResources().getText(C0085R.string.abc_action_bar_up_description));
        } else {
            this.mHomeLayout.setContentDescription(this.mContext.getResources().getText(C0085R.string.abc_action_bar_home_description));
        }
    }
            ...
            switch (mode) {
                case DataEvent.TYPE_CHANGED /*1*/:
                    if (this.mSpinner == null) {
                        this.mSpinner = new SpinnerICS(this.mContext, null, C0085R.attr.actionDropDownStyle);
                        this.mListNavLayout = (LinearLayout) LayoutInflater.from(this.mContext).inflate(C0085R.layout.abc_action_bar_view_list_nav_layout, null);
    ...
    private void initTitle() {
        ...
        if (this.mTitleLayout == null) {
            boolean homeAsUp;
            boolean showHome;
            this.mTitleLayout = (LinearLayout) LayoutInflater.from(getContext()).inflate(C0085R.layout.abc_action_bar_title_item, this, false);
            this.mTitleView = (TextView) this.mTitleLayout.findViewById(C0085R.id.action_bar_title);
            this.mSubtitleView = (TextView) this.mTitleLayout.findViewById(C0085R.id.action_bar_subtitle);
            this.mTitleUpView = this.mTitleLayout.findViewById(C0085R.id.up);
