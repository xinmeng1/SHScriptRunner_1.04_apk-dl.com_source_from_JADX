...
public class ProgressBarICS extends View {
    ...
    static class SavedState extends BaseSavedState {
        ...
        static class C01031 implements Creator<SavedState> {
            C01031() {
            }
    ...
    private void initProgressBar() {
        ...
        this.mDuration = WearableStatusCodes.TARGET_NODE_NOT_CONNECTED;
        this.mBehavior = 1;
        this.mMinWidth = 24;
        this.mMaxWidth = 48;
        this.mMinHeight = 24;
            ...
            if (this.mOnlyIndeterminate && !(this.mIndeterminateDrawable instanceof AnimationDrawable)) {
                ...
                if (intrinsicAspect != boundAspect) {
                    if (boundAspect > intrinsicAspect) {
                        ...
                        int height = (int) (((float) w) * (TextTrackStyle.DEFAULT_FONT_SCALE / intrinsicAspect));
                        top = (h - height) / 2;
                        bottom = top + height;
                    }
                }
