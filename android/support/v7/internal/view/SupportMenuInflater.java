...
public class SupportMenuInflater extends MenuInflater {
    ...
    private class MenuState {
        ...
        public void readGroup(AttributeSet attrs) {
            TypedArray a = SupportMenuInflater.this.mContext.obtainStyledAttributes(attrs, C0085R.styleable.MenuGroup);
        ...
        public void readItem(AttributeSet attrs) {
            TypedArray a = SupportMenuInflater.this.mContext.obtainStyledAttributes(attrs, C0085R.styleable.MenuItem);
            this.itemId = a.getResourceId(2, defaultItemOrder);
            this.itemCategoryOrder = (SupportMenu.CATEGORY_MASK & a.getInt(5, this.groupCategory)) | (GameRequest.TYPE_ALL & a.getInt(6, this.groupOrder));
