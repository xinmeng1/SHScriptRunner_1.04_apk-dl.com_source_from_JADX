...
class SearchViewCompatHoneycomb {
    ...
    static class C00701 implements OnQueryTextListener {
        final /* synthetic */ OnQueryTextListenerCompatBridge val$listener;

        C00701(OnQueryTextListenerCompatBridge onQueryTextListenerCompatBridge) {
    ...
    static class C00712 implements OnCloseListener {
        final /* synthetic */ OnCloseListenerCompatBridge val$listener;

        C00712(OnCloseListenerCompatBridge onCloseListenerCompatBridge) {
