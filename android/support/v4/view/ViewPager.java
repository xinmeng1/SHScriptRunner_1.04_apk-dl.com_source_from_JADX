...
public class ViewPager extends ViewGroup {
    ...
    static class C00491 implements Comparator<ItemInfo> {
        C00491() {
        }
    ...
    static class C00502 implements Interpolator {
        C00502() {
        }
    ...
    public static class SavedState extends BaseSavedState {
        ...
        static class C05911 implements ParcelableCompatCreatorCallbacks<SavedState> {
            C05911() {
            }
        ...
        static {
            CREATOR = ParcelableCompat.newCreator(new C05911());
        }
    ...
    static {
        ...
        LAYOUT_ATTRS = iArr;
        COMPARATOR = new C00491();
        sInterpolator = new C00502();
    ...
    public ViewPager(Context context) {
        ...
        this.mEndScrollRunnable = new C00513();
