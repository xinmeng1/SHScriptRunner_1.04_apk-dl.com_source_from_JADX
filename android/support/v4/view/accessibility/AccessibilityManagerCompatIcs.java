...
class AccessibilityManagerCompatIcs {
    ...
    static class C00561 implements AccessibilityStateChangeListener {
        final /* synthetic */ AccessibilityStateChangeListenerBridge val$bridge;

        C00561(AccessibilityStateChangeListenerBridge accessibilityStateChangeListenerBridge) {
