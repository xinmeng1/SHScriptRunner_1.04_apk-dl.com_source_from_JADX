...
public class TransportMediator extends TransportController {
    ...
    class C00212 implements Callback {
        C00212() {
        }
    ...
    class C05831 implements TransportMediatorCallback {
        C05831() {
        }
    ...
    private TransportMediator(Activity activity, View view, TransportPerformer callbacks) {
        ...
        this.mTransportKeyCallback = new C05831();
        this.mKeyEventCallback = new C00212();
