...
class TransportMediatorJellybeanMR2 implements OnGetPlaybackPositionListener, OnPlaybackPositionUpdateListener {
    ...
    class C00221 implements OnWindowAttachListener {
        C00221() {
        }
    ...
    class C00232 implements OnWindowFocusChangeListener {
        C00232() {
        }
    ...
    class C00243 extends BroadcastReceiver {
        C00243() {
        }
    ...
    class C00254 implements OnAudioFocusChangeListener {
        C00254() {
        }
    ...
    public TransportMediatorJellybeanMR2(Context context, AudioManager audioManager, View view, TransportMediatorCallback transportCallback) {
        this.mWindowAttachListener = new C00221();
        this.mWindowFocusListener = new C00232();
        this.mMediaButtonReceiver = new C00243();
        this.mAudioFocusChangeListener = new C00254();
        this.mPlayState = 0;
